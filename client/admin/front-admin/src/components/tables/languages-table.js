...
`
    ...
    this.data.rows.forEach(register => {
      ...
      tableRegisterBodyList.appendChild(aliasLi)
      aliasLi.textContent = `Alias: ${register.alias}`
      ...
      tableRegisterBodyList.appendChild(selectedLi)
      selectedLi.textContent = `Seleccionado: ${register.selected ? '✅' : '❌'}`

      const defaultLi = document.createElement('li')
      tableRegisterBodyList.appendChild(defaultLi)
      defaultLi.textContent = `Por defecto: ${register.default ? '✅' : '❌'}`
